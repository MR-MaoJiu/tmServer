...
class Upload extends Common
{
    ...
    public function upload(Request $request)
    {
        ...
        if ($info) {
            // 成功上传后 获取上传信息
            // 输出 jpg
            $path = '/uploads/admin/images/' . $info->getSaveName();
    ...
    {
//        $file = $request->file('file');
//        $secretId = "AKIDmPK5eEee290cw0rpKYVGnwoOhkW2uSGs"; //"云 API 密钥 SecretId";
//        $secretKey = "TgdIgrnWy92g392hDUTDgsnV9k58vQgg"; //"云 API 密钥 SecretKey";
...
//                    'secretKey' => $secretKey)));
//        try {
//            $bucket = "jytx-1301890194"; //存储桶名称 格式：BucketName-APPID
//            $key = "exampleobject";
...
//////        usleep(5000);
////        // Settings
////        $targetDir = './uploads/videos/admin'.DIRECTORY_SEPARATOR.'file_material_tmp';            //存放分片临时目录
////        if($folder){
////            $uploadDir = './uploads/videos/admin'.DIRECTORY_SEPARATOR.'file_material'.DIRECTORY_SEPARATOR.$folder.DIRECTORY_SEPARATOR.date('Ymd');
////        }else{
////            $uploadDir = './uploads/videos/admin'.DIRECTORY_SEPARATOR.'file_material'.DIRECTORY_SEPARATOR.date('Ymd');    //分片合并存放目录
////        }
////
